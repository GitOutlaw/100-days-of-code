...
with open("day24/mail_merge_project/input/names/invited_names.txt", 'r') as names:

    # Opens the starting_letter.txt file, reads & locates line that will be replaced.
    with open("day24/mail_merge_project/input/letters/starting_letter.txt", 'r', encoding='utf-8') as mail_file:
        ...
        for name in names:
            ...
            with open("day24/mail_merge_project/output/ready_to_send/letter_for_"+name.strip()+".txt", "w") as individual_mail:
